...
var animate = function animate() {
  ...
  c.strokeStyle = "hsl(".concat(strokeColor.h * Math.abs(Math.sin(increment)), ", ").concat(strokeColor.s, "%, ").concat(strokeColor.l, "%)");
  c.stroke();
  increment += wave.frequency;
};

animate();
},{"dat.gui":"node_modules/dat.gui/build/dat.gui.module.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
